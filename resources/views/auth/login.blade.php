<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- Aligning Login Button with Form Inputs -->
            <div class="mt-4">
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('register') }}" class="underline text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-200">
                        {{ __('Register Here') }}
                    </a>
                </p>
            </div>
